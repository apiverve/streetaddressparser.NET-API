...
namespace APIVerve
{
    public class StreetAddressParserAPIClient
    {
        ...
        public StreetAddressParserAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }

        public StreetAddressParserAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public ResponseObj Execute(streetaddressparserQueryOptions options)
        {
            try
            {
                if (_isDebug)
